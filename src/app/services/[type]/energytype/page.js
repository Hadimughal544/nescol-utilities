        ...
        <main>
            ...
            <div className="absolute inset-0 z-20 py-20 px-10 pb-10 flex    ">
                    <div className="space-y-6">
                        ...
                        <h2 className=" text-xl md:text-2xl  text-blue-950 font-bold ">
                            Unlock the most cost-effective utility solutions tailored <br></br>for your business
                        </h2>
                    ...
                    <h1 className=" text-2xl font-bold">Cut expenses. Work smarter.</h1>
